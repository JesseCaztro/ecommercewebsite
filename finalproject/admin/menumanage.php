<div class="container-fluid" style="margin-top:98px">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form action="admin/menumanage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-body">
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: rgb(111 202 203);">
								<tr>
									<th class="text-center" style="width:7%;">Product Id</th>
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            <td class="text-center">' .$categorieId. '</td>
                                            <td>
                                                <img src="/finalproject/img/product-'.$productId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Name : <b>' .$name. '</b></p>
                                            ...
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													...
													<form action="admin/menumanage.php" method="POST">
...
<?php 
    ...
    while($row = mysqli_fetch_assoc($productaResult)){
        $productId = $row['productId'];
        $name = $row['name'];
        $price = $row['price'];
        $description = $row['description'];
	  	...
	  	<form action="admin/menumanage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/finalproject/img/product-<?php echo $productId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="admin/menumanage.php" method="post">
