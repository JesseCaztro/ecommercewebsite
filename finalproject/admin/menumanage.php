...
<!-- Modal -->
<div class="modal fade" id="updateItem<?php echo $productId; ?>" tabindex="-1" role="dialog" aria-labelledby="updateItem<?php echo $pizzaId; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	  	<form action="_menuManage.php" method="post" enctype="multipart/form-data">
