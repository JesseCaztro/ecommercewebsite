...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form method="get" action="/finalproject/search.php" class="form-inline my-2 my-lg-0 mx-3">
        ...
        $countsql = "SELECT SUM(`quantity`) FROM `cart` WHERE `cartItemId`=$cartItemId"; 
        ...
        echo '<a href="cart.php"><button type="button" class="btn btn-secondary mx-2" title="MyCart">
